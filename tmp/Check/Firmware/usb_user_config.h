...
// Product Name
// will be a part of the descriptor and can be requested by the host
#define STR_PRODUCT				L"UxDIL Device Check"
...
#define VENDOR_ID		0x20A0	// you can use this VID for your experiments

// Product ID
// set your product ID here
#define PRODUCT_ID		0x411B	// you can use this PID for your experiments
...
static const ep_config EP_CONFIG[MAX_ENDPOINT] = {
  ...
  // modify the following lines for your purposes
	{EP_TYPE_BULK_OUT, 16, EP_SINGLE_BUFFER},				
	{EP_TYPE_BULK_IN,  16, EP_SINGLE_BUFFER},				
