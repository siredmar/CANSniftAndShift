...
#define STR_MANUFACTURER	L"Reusch Elektronik"

// Product Name
// will be a part of the descriptor and can be requested by the host
#define STR_PRODUCT				L"Raw HID Demo"
...
#define PRODUCT_ID	0x0002	// !!! THIS ID IS NOT FOR OFFICIAL USE, FOR YOUR PERSONAL TESTING PURPOSES ONLY !!!

// USB device class
// possible settings:
#define USBDEVICECLASS_RAWHID	0x00	// raw "human interface device"
#define USBDEVICECLASS_USER		0xFF	// user defined class
// set the class for your purposes
#define USBDEVICECLASS	USBDEVICECLASS_RAWHID
...
#define VBUSPORT	PINC	// used port (port C as example)
...
#define RAWHID_TX_ENDPOINT	1				// endpoint for data transmission to host
#define RAWHID_RX_ENDPOINT	2				// endpoint for data receive from host
...
#define ENDPOINT0_SIZE						32	// control endpoint
// uncomment the following line to handle user defined control request
// of endpoint 0 in the main program
//#define USERDEFCONTROLS		// can't be used with Atmel USB HID DLL
...
static const ep_config EP_CONFIG[MAX_ENDPOINT] = {
  ...
  // modify the following lines for your purposes
	{EP_TYPE_INTERRUPT_IN,  64, EP_SINGLE_BUFFER},				
	{EP_TYPE_INTERRUPT_OUT, 64, EP_SINGLE_BUFFER},				
