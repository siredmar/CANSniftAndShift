...
//#define ADDR_CHECK(FUNC) if (lp##FUNC == NULL) {printf(stderr,"%s\n", "Error: Cannot get address of function."); return FALSE;}
#define ADDR_CHECK(FUNC) if (lp##FUNC == NULL) {ShowMessage("Error: Cannot get address of function."); return FALSE;}
