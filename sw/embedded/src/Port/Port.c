...
uint8 PinNumber_ui8;
uint8 PortNumber_ui8;

void Port_Init(void)
{
    uint8 PortCounter_ui8;
    uint8 PinCounter_ui8;
    ...
    {
        for(PinCounter_ui8 = 0; PinCounter_ui8 < PORT_MAX_NUMBER_OF_PINS; PinCounter_ui8++)
        {
            PortNumber_ui8 = (uint8)(((localConfig->Pin[PinCounter_ui8].Port_PortPin_e) >> 8) & 0xFF);
            PinNumber_ui8 = (uint8)(((localConfig->Pin[PinCounter_ui8].Port_PortPin_e) & 0xFF));


            /* Set GPIO - Peripheral mode for selected Pin */
            if(localConfig->Pin[PinCounter_ui8].Port_PeripheralMode_e == GPIO_MODE)
            {
                *(Port_RegisterAdress_as[PortNumber_ui8].Port_GpioEnableRegister_pui32) |= (uint32)(1 << PinNumber_ui8);
                *(Port_RegisterAdress_as[PortNumber_ui8].Port_PeripheralMux0Register_pui32) &= ~ (uint32)(1 << PinNumber_ui8);
                *(Port_RegisterAdress_as[PortNumber_ui8].Port_PeripheralMux1Register_pui32) &= ~ (uint32)(1 << PinNumber_ui8);
                *(Port_RegisterAdress_as[PortNumber_ui8].Port_PeripheralMux2Register_pui32) &= ~ (uint32)(1 << PinNumber_ui8);

                /* Set Input/Output mode for selected Pin */
                Port_PinInOut_e = localConfig->Pin[PinCounter_ui8].Port_PinInOut_e;
                if(Port_PinInOut_e == PIN_OUTPUT)
                {
                    *(Port_RegisterAdress_as[PortNumber_ui8].Port_OutputDriverEnableRegister_pui32) |= (uint32)(1 << PinNumber_ui8);

                    /* Set initial Output for selected Pin */
                    PortPinInitialState_e = localConfig->Pin[PinCounter_ui8].Port_PinInitialState_e;
                    *(Port_RegisterAdress_as[PortNumber_ui8].Port_OutputValueRegister_pui32) |= (uint32)(((uint8)PortPinInitialState_e) << PinNumber_ui8);
                }
                else
                {
                    *(Port_RegisterAdress_as[PortNumber_ui8].Port_OutputDriverEnableRegister_pui32) &= ~(uint32)(1 << PinNumber_ui8);
                ...
                Port_PullUpDown_e = localConfig->Pin[PinCounter_ui8].Port_PullUpDown_e;
                switch(Port_PullUpDown_e)
                {
                    case NO_PULLUP_PULLDOWN:
                    {
                        *(Port_RegisterAdress_as[PortNumber_ui8].Port_PullDownEnableRegister_pui32) &= ~(uint32)(1 << PinNumber_ui8);
                        *(Port_RegisterAdress_as[PortNumber_ui8].Port_PullUpEnableRegister_pui32)   &= ~ (uint32)(1 << PinNumber_ui8);
                        break;
                    }
            ...
            {
                PeripheralMode_e = localConfig->Pin[PinCounter_ui8].Port_PeripheralMode_e;
                *(Port_RegisterAdress_as[PortNumber_ui8].Port_PeripheralMux0Register_pui32) |= (uint32)((PeripheralMode_e & 0x01) << PinNumber_ui8);
                *(Port_RegisterAdress_as[PortNumber_ui8].Port_PeripheralMux1Register_pui32) |= (uint32)(((PeripheralMode_e >> 1) & 0x01) << PinNumber_ui8);
                *(Port_RegisterAdress_as[PortNumber_ui8].Port_PeripheralMux2Register_pui32) |= (uint32)(((PeripheralMode_e >> 2) & 0x01) << PinNumber_ui8);
            }
            /* Set Interrupt mode for selected Pin */
            Port_Interrupt_Mode_e = localConfig->Pin[PinCounter_ui8].Port_Interrupt_Mode_e;
            switch(Port_Interrupt_Mode_e)
            {
                ...
                {
                    *(Port_RegisterAdress_as[PortNumber_ui8].Port_InterruptMode0Register_pui32)  &= ~(uint32)(1 << PinNumber_ui8);
                    *(Port_RegisterAdress_as[PortNumber_ui8].Port_InterruptMode1Register_pui32)  &= ~(uint32)(1 << PinNumber_ui8);
                    *(Port_RegisterAdress_as[PortNumber_ui8].Port_InterruptEnableRegister_pui32) |= (uint32)(1 << PinNumber_ui8);
                    break;
                }
            ...
            Port_GlitchFilterState_e = localConfig->Pin[PinCounter_ui8].Port_GlitchFilterState_e;
            if(Port_GlitchFilterState_e == GLITCH_FILTER_ENABLED)
            {
                *(Port_RegisterAdress_as[PortNumber_ui8].Port_GlitchFilterEnableRegister_pui32) |= (uint32)(1 << PinNumber_ui8);
            }

            /* Set Output driver strenght for selected Pin */
            Port_OutputDriver_e = localConfig->Pin[PinCounter_ui8].Port_OutputDriver_e;
            switch(Port_OutputDriver_e)
            {
                ...
                {
                    *(Port_RegisterAdress_as[PortNumber_ui8].Port_OutputDriverCapa0Register_pui32) |= (uint32)(1 << PinNumber_ui8);
                    *(Port_RegisterAdress_as[PortNumber_ui8].Port_OutputDriverCapa1Register_pui32) &= ~(uint32)(1 << PinNumber_ui8);
                    break;
                }
